...
public final class FirstAidRegistries {
   public static final Registry<MapCodec<? extends IDamageDistributionAlgorithm>> DAMAGE_DISTRIBUTION_ALGORITHMS = FabricRegistryBuilder.create(
         FirstAidRegistries.Keys.DAMAGE_DISTRIBUTION_ALGORITHMS
      )
      .attribute(RegistryAttribute.SYNCED)
      .buildAndRegister();
   public static final Registry<MapCodec<? extends IDamageDistributionTarget>> DAMAGE_DISTRIBUTION_TARGETS = FabricRegistryBuilder.create(
         FirstAidRegistries.Keys.DAMAGE_DISTRIBUTION_TARGETS
      )
      .attribute(RegistryAttribute.SYNCED)
      .buildAndRegister();
   public static final Registry<MapCodec<? extends IDebuffBuilder>> DEBUFF_BUILDERS = FabricRegistryBuilder.create(
