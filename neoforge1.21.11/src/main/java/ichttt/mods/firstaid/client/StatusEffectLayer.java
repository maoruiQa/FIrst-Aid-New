...
public class StatusEffectLayer implements GuiLayer {
    ...
    private static void renderRescuePrompt(GuiGraphics guiGraphics, Minecraft minecraft, int centerX, int centerY, float partialTick) {
        ...
        guiGraphics.drawCenteredString(
                ...
                centerX,
                centerY - 26,
                healingPrompt ? opaque(0x74D6FF) : (executionPrompt ? opaque(0xFFD7CC) : opaque(0xE9F7E2))
        );
        guiGraphics.drawCenteredString(
                minecraft.font,
                ...
                centerX,
                centerY - 12,
                healingPrompt ? opaque(0x9E9EDE) : (executionPrompt ? opaque(0xEFD2D2) : opaque(0xCFE4C5))
        );
        ...
        guiGraphics.drawCenteredString(
                ...
                centerX,
                top + 12,
                healingPrompt ? opaque(0xAEEFCC) : (executionPrompt ? opaque(0xFFB7A0) : opaque(0xD8F0D0))
        );
    }
